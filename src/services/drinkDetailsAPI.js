const url = 'https://www.themealdb.com/api/json/v1/1/search.php?s='; // busca por recomendações
const url2 = 'https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i='; // busca por detalhes
